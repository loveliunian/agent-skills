...
# devflow — PRD to production（v3.30.10）
...
**Gate 强制闭环（v3.30.0 起全量，收据绑定 `*_JSON`+SHA256）**：P0/P0b/P1 三正本/P2/P2a/P2b/P3/P3b/P3c/P3d/P4/P5/P7/P8/P9/P10 双正本/小改动（P6 为 verification 证据树形态）；P4b、P3-build、P5-migration、P6 accuracy/credential 暂无专属 JSON 正本。
