...
<!-- 审计指纹: verification.json sha256=9e820f9f0b4c424e63f3f93f4e3c55de75522d2e9a0b166c647359c96280a7e3 -->
...
|---|---|---|---|---|---|---|
| 单元测试 | pytest -q | 0 | 0 | report-unit.txt | ef92c40303e6… | unit.log |
| 集成测试 | mvn verify | 0 | 0 | report-integration.txt | 101a600ee1f7… | — |
| 客户端测试 | npm run test:e2e | 0 | 0 | report-client.txt | 4bc78025a34c… | — |
| 负载测试 | jmeter -n -t plan.jmx | 0 | 0 | report-load.txt | c68674d95741… | — |
| 预发布验证 | ./scripts/smoke.sh staging | 0 | 0 | report-staging.txt | c45bb1dcdb95… | — |
